...
export class Dead<S, F extends Error> extends Superposition<S, F> {
  ...
  public match<T>(alive: BiFunction<S, Alive<S, F>, Promise<T>>, dead: BiFunction<F, Dead<S, F>, Promise<T>>): Promise<T>;
  public match<T, E extends Error>(alive: BiFunction<S, Alive<S, F>, Superposition<T, E>>, dead: BiFunction<F, Dead<S, F>, Superposition<T, E>>): Superposition<T, E>;
  public match<T, E extends Error>(alive: BiFunction<S, Alive<S, F>, Promise<Superposition<T, E>>>, dead: BiFunction<F, Dead<S, F>, Promise<Superposition<T, E>>>): Promise<Superposition<T, E>>;
  public match<T, E extends Error = F>(
    ...
    dead: BiFunction<F, Dead<S, F>, T> | BiFunction<F, Dead<S, F>, Promise<T>> | BiFunction<F, Dead<S, F>, Superposition<T, E>> | BiFunction<F, Dead<S, F>, Promise<Superposition<T, E>>>
