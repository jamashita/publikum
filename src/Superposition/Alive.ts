...
export class Alive<S, F extends Error> extends Superposition<S, F> {
  ...
  public match<T>(alive: BiFunction<S, Alive<S, F>, T>, failure: BiFunction<F, Failure<S, F>, T>): T;
  public match<T>(alive: BiFunction<S, Alive<S, F>, Promise<T>>, failure: BiFunction<F, Failure<S, F>, Promise<T>>): Promise<T>;
  public match<T, E extends Error>(alive: BiFunction<S, Alive<S, F>, Superposition<T, E>>, failure: BiFunction<F, Failure<S, F>, Superposition<T, E>>): Superposition<T, E>;
